...
const adicionarParticipante = (event/** esse é o argumento da função */) => {
  ...
  //verificar se o participante já existe. inicio
  ...
  //verificar se o participante já existe. fim
